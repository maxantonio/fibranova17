...
def contacto(request):
    ...
    context = {'title': _('Contacto'), 'header_img': header_img}
...
def noticia(request, no):
    header_img = staticfiles_storage.url('images/background/noticias.png')
    context = {'title': _('Noticia'), 'urlbase': urlbase, 'header_img': header_img}
...
def indicadores_operativos(request):
    ...
    context = {'title': _('Indicadores Operativos'), 'header_img': header_img}
...
def perfil_nosotros(request):
    ...
    context = {'title': _('Nosotros'), 'header_img': header_img}
...
def presencia_geografica(request):
    ...
    context = {'title': _('Presencia Geográfica'), 'header_img': header_img}
...
def historia(request):
    ...
    context = {'title': _('Historia'), 'header_img': header_img}
...
def estrategia(request):
    ...
    context = {'title': _('Estrategia'), 'header_img': header_img}
    return render(request, f'frontend/{request.LANGUAGE_CODE}/perfil/estrategia.html', context)


def video(request):
    header_img = staticfiles_storage.url('images/background/estrategia.png')
    context = {'title': _('Video Corporativo'), 'header_img': header_img}
...
def reportes_anuales(request):
    ...
    context = {'title': _('Reportes Anuales'), 'urlbase': urlbase, 'header_img': header_img}
...
def fundamentales(request):
    ...
    context = {'title': _('Fundamentales'), 'header_img': header_img}
...
def eventos_relevantes(request):
    ...
    context = {'title': _('Eventos Relevantes'),
               'urlbase': urlbase, 'header_img': header_img}
...
def faqs(request):
    ...
    context = {'title': _('Preguntas Frecuentes'), 'header_img': header_img}
...
def distribuciones(request):
    ...
    context = {'title': _('Distribuciones'), 'urlbase': urlbase, 'header_img': header_img}
...
def cotizacion(request):
    ...
    context = {'title': _('Cotización'), 'header_img': header_img}
...
def precio_historico(request):
    ...
    context = {'title': _('Precio Histórico'), 'header_img': header_img}
...
def calculadora(request):
    ...
    context = {'title': _('Calculadora de Rendimientos'), 'header_img': header_img}
...
def cobertura_analistas(request):
    ...
    context = {'title': _('Cobertura de Analistas'), 'header_img': header_img}
...
def directivos(request):
    ...
    context = {'title': _('Directivos'), 'header_img': header_img}
...
def comites(request):
    ...
    context = {'title': _('Comités'), 'header_img': header_img}
...
def auditor_externo(request):
    ...
    context = {'title': _('Auditor Externo'), 'header_img': header_img}
...
def prospectos_suplementos(request):
    ...
    context = {'title': _('Prospectos y Suplementos'), 'urlbase': urlbase, 'header_img': header_img}
...
def asambleas(request):
    ...
    context = {'title': _('Asambleas'), 'urlbase': urlbase, 'header_img': header_img}
...
def codigo_etica(request):
    ...
    context = {'title': _('Código de Ética'), 'urlbase': urlbase, 'header_img': header_img}
...
def esg(request):
    ...
    context = {'title': _('ESG'), 'urlbase': urlbase, 'header_img': header_img}
